...
function createDefaultProject(): Project {
  ...
  const baseInputs: ProjectInputs = {
    name: 'Mon Projet',
    revenue: {
      averageDailyRate: { value: 200, sourceInfo: { source: '', remarks: '' } },
      occupancyRate: { value: 60, sourceInfo: { source: '', remarks: '' } },
      daysPerYear: 365,
    },
    expenses: [
      {
    ...
    financing: {
      purchasePrice: { value: 400000 },
      downPayment: { value: 100000 },
      interestRate: { value: 5.5 },
      amortizationYears: { value: 25 },
      paymentFrequency: PaymentFrequency.MONTHLY,
    },
    acquisitionFees: {
      transferDuties: { value: 8000 },
